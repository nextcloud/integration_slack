OC.L10N.register(
    ...
    "Slack integration lets you send files to Slack from Nextcloud Files." : "مُكاملة Slack تُمكِّنُك من إرسال ملفات إلى Slack من ملفات نكست كلاود.",
    "Slack admin options saved" : "تمّ حفظ خيارات مدير Slack",
    "Failed to save Slack admin options" : "تعذّر حفظ خيارات مدير Slack",
    "Slack integration" : "مُكاملة Slack",
    "To allow your Nextcloud users to use OAuth to authenticate to the Slack app, and set the ID and secret here." : "لتمكين مستخدمي نكست كلاود عندك من استعمال التصديق المفتوح OAuth للتحقق من الهوية مع تطبيق Slack، و تعيين المُعرِّف و كلمة السر هنا.",
    ...
    "The admin must fill in client ID and client secret for you to continue from here" : "يجب على المشرف ملء خانات \"معرف العميل\" client ID و \"سر العميل\" client secret لك كي تستمر.",
    ...
    "Conversation" : "محادثة",
    "Refresh channels" : "تحديث القنوات",
